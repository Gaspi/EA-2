...
\begin{itemize}
 \item Basée sur l'équivalence entre codes GRS : $\exists H',(\alpha'_3, \ ... \ \alpha'_{k-1}, \alpha'_{k+1},\ ... \ , \alpha'_n)$ et $(z'_1, \ ... \ z'_{k-1},z'_{k+1}, \ ... \ z'_n)$ tels que
 $$H\cdot G=H'\cdot G(0,1,\alpha'_3, \ ... \ ,\infty ,\alpha'_{k+1},\ ... \ , \alpha'_n,z'_1, \ ... \ ,1,z'_{k+1}, \ ... \ z'_n)$$
